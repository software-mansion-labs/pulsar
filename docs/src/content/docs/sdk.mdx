...
This page covers concepts that apply across all Pulsar SDKs: types of haptics, preloading, and caching. Read this page before the platform-specific guides for [iOS](/sdk/ios), [Android](/sdk/android), or [React Native](/sdk/react-native).
...
A discrete haptic produces a short, single burst of feedback at one point in time, such as a tap, a click, or a notification buzz. Three properties define each event:

| Property    | Range | Description                                                      |
| ----------- | ----- | ---------------------------------------------------------------- |
| `time`      | ms    | When the event fires, relative to the pattern start              |
| `amplitude` | 0 – 1 | Intensity of the haptic                                          |
| `frequency` | 0 – 1 | Sharpness of the haptic (low values feel round, high feel crisp) |
